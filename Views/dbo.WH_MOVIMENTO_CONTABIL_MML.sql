...
GO
CREATE VIEW [dbo].[WH_MOVIMENTO_CONTABIL_MML] 
AS -- =====================================================
...
SELECT 
  ...
  ''
    ...
    CONCAT_WS('-', 'MML', LCT.CODEMP, PLA.CLACTA) AS 'KEY CONTA CONTÁBIL',
...
-- ===============================================
FROM  [SQLMML].[Sapiens_Prod].[dbo].[E640LCT] LCT WITH (NOLOCK) -- Tabela principal de lançamentos contábeis
...
SELECT
    ...
    CONCAT_WS('-', 'MML', E650SAL.CODEMP, PLA.CLACTA) AS 'KEY CONTA CONTÁBIL',
...
-- ===============================================
FROM  [SQLMML].[Sapiens_Prod].[dbo].[E650SAL] E650SAL WITH (NOLOCK) -- Tabela de saldos contábeis
