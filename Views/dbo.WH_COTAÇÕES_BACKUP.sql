...
GO
CREATE   VIEW [dbo].[WH_COTAÇÕES_BACKUP] 
...
SELECT
    ...
    IIF(CAST(E410COT.DATAPR AS DATE)='31/12/1900',NULL,CAST(E410COT.DATAPR AS DATE)) 'DATA APROVAÇÃO',                -- Data da aprovação
    ...
    IIF(CAST(E410COT.DATOCP AS DATE)='31/12/1900',NULL,CAST(E410COT.DATOCP AS DATE)) 'DATA ORDEM COMPRA',             -- Data geração ordem compra
