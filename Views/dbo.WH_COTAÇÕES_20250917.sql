...
GO
CREATE   VIEW [dbo].[WH_COTAÇÕES_20250917] 
...
SELECT
    ...
    E420IPO.SEQIPO 'SEQ ITEM ORDEM COMPRA',                      -- Sequência item ordem compra
...
FROM SAPIENS.SAPIENS.E410COT WITH (NOLOCK)                        -- Tabela principal: Cotações
    ...
    LEFT OUTER JOIN SAPIENS.SAPIENS.E420IPO WITH (NOLOCK)
     ...
     --  AND E410COT.CODSER = E420IPO.CODDER
       -- AND ((E410COT.PROSER = 'P' AND E410COT.CODPRO = E420IPO.CODPRO AND ISNULL(E410COT.CODDER,'') = ISNULL(E420IPO.CODDER,'')) OR (E410COT.PROSER = 'S'))
    ...
    -- NOTA FISCAL DE COMPRA/ENTRADA
    LEFT OUTER JOIN SAPIENS.SAPIENS.E440NFC WITH (NOLOCK)
        ON E440IPC.CODEMP = E440NFC.CODEMP
